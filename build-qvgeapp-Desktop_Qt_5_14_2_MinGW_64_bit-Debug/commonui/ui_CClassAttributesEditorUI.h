...
public:
    ...
    void retranslateUi(QWidget *CClassAttributesEditorUI)
    {
        ...
        GraphButton->setText(QCoreApplication::translate("CClassAttributesEditorUI", "Graph", nullptr));
#if QT_CONFIG(statustip)
        NodeButton->setStatusTip(QCoreApplication::translate("CClassAttributesEditorUI", "Edit default node attributes", nullptr));
#endif // QT_CONFIG(statustip)
        NodeButton->setText(QCoreApplication::translate("CClassAttributesEditorUI", "Node", nullptr));
#if QT_CONFIG(statustip)
        EdgeButton->setStatusTip(QCoreApplication::translate("CClassAttributesEditorUI", "Edit default edge attributes", nullptr));
#endif // QT_CONFIG(statustip)
        EdgeButton->setText(QCoreApplication::translate("CClassAttributesEditorUI", "Edge", nullptr));
#if QT_CONFIG(statustip)
...
#endif // QT_CONFIG(statustip)
        AddButton->setText(QCoreApplication::translate("CClassAttributesEditorUI", "Add...", nullptr));
#if QT_CONFIG(statustip)
...
#endif // QT_CONFIG(statustip)
        ChangeButton->setText(QCoreApplication::translate("CClassAttributesEditorUI", "Change...", nullptr));
#if QT_CONFIG(statustip)
...
#endif // QT_CONFIG(statustip)
        RemoveButton->setText(QCoreApplication::translate("CClassAttributesEditorUI", "Remove...", nullptr));
    } // retranslateUi
