...
#include <TuringInterface.h>    // 加入 TuringInterface 头文
...
void CNodeEditorUIController::createPanels()
{
    ...
    // 新增的 TuringInterface 窗口
    auto turingWindow = new TuringInterface();
    turingWindow->graphFromScene = m_connectionsPanel->getScene();
